...
namespace CrossTableSilverlight.Model
{
    ...
    public class KeyWordSummary : GalaSoft.MvvmLight.ViewModelBase,MyLib.Interface.ITsv
    {
        ...
        public void CreateTinySegmenter(Question q, MyLib.IO.TSVFileBase file, Action<int> progress, Action endAction)
        {
     ...
     //               tinySegmenter.LearningParallel(list, segmenter学習時の最低支持率 / 100, 100, 4, n => bw.ReportProgress(n));
                  tinySegmenter.Learning(list, segmenter学習時の最低支持率 / 100,Segmenter学習時のNgram);
                }
