...
namespace CrossTableSilverlight.Model
{
    public class GroupQuestionSum : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Visibility Visibility
        {
            get
            {
                Visibility tmpVisibility = System.Windows.Visibility.Visible;
                if (Parent.MinCount > this.Count)
                {
                    tmpVisibility = System.Windows.Visibility.Collapsed;
                }
        ...
        Brush colorBrush = new SolidColorBrush(Colors.White);
