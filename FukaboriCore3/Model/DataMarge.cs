...
namespace FukaboriCore.Model
{
    ...
    {
        public ReactiveCollection<string> Header { get; set; } = new ReactiveCollection<string>();
        public ReactiveCollection<string> KeyHeader { get; set; } = new ReactiveCollection<string>();
        public ReactiveCollection<Question> QuestionList { get; set; } = new ReactiveCollection<Model.Question>();

        public string SelectedKey { get; set; }
        public IList SelectedHeader { get; set; }
        public Question SelectedKeyQuestion { get; set; }
        public ReactiveProperty<string> InputText { get; } = new ReactiveProperty<string>(string.Empty);
//        public NotifyProperty<string> SelectedFileName { get; set; } = new NotifyProperty<string>();

        public void Init()
        {
            Header = new ReactiveCollection<string>();
            KeyHeader = new ReactiveCollection<string>();
            QuestionList = new ReactiveCollection<Model.Question>();
...
//                    keyDataDic.GetValueOrAdd(key, item.GetValue(h, string.Empty));
            ...
            Messenger.Default.Send<NotificationMessage>(new NotificationMessage("完了"));
